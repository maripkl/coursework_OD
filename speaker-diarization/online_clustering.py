...
class Cluster():
    def __init__(self, label, dist_metric=cdist):
        ...
        self.representation = np.zeros(512)  # cluster embedding
    ...
    def distance(self,data):
        ...
        for embedding in self.embeddings:
            dists += list(self.dist_metric(embedding.reshape(1, -1), feature.reshape(1, -1), metric='cosine').flatten())
    ...
    def distance2(self,data):
        ...
        return self.dist_metric(self.representation.reshape(1, -1), feature.reshape(1, -1), metric='cosine')[0, 0]
    ...
    def updateCluster(self,data):
        ...
        self.representation += data['embedding']
...
class OnlineClustering():
    ...
    def computeDistances2(self, data):
        """Compare new coming data with clusters"""
        # return [cluster.distance(data) for cluster in self.clusters]
        # print([cluster.distance2(data) for cluster in self.clusters])
